...
if ("${ITK_RELEASE_VERSION}" STREQUAL "5")
  set( ITK_GIT_TAG "v5.1.0")
  set( ITK_VERSION 5.1 )
elseif ("${ITK_RELEASE_VERSION}" STREQUAL "4")
...
if( NOT USE_SYSTEM_VTK )
  ...
  if ("${VTK_RELEASE_VERSION}" STREQUAL "9")
    set( VTK_GIT_TAG "v9.0.0")
    set( VTK_VERSION 9.0 )
  elseif ("${VTK_RELEASE_VERSION}" STREQUAL "8")
  ...
  ExternalProject_Add( VTK
    ...
    CMAKE_ARGS
      ...
      -DPython3_DEBUG_LIBRARY=${PYTHON_DEBUG_LIBRARY}
      ...
      -DVTK_SMP_IMPLEMENTATION_TYPE=${VTK_SMP_IMPLEMENTATION_TYPE}
...
ExternalProject_Add( ${proj}
  ...
  CMAKE_ARGS
    ...
    -DCMAKE_INSTALL_RPATH=${SUPERBUILD_INSTALL_PREFIX}/lib;@rpath
    -DCMAKE_INSTALL_RPATH_USE_LINK_PATH=TRUE
    -DVMTK_PYTHON_VERSION=${VMTK_PYTHON_VERSION}
