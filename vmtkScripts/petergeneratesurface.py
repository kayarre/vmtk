...
# Class name which differs from file naming convention
petergeneratesurface = 'peterGenerateSurface'

# Class definition
# Will need to contain an image as input and renderer
# Output will be a surface and a transform
class peterGenerateSurface(pypes.pypeScript):
    def __init__(self):
        ...
        self.SetScriptName('peterGenerateSurface')
